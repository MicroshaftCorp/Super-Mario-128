...
.defineLabel ascii_HelloDMACopy_ROM_start, 0x7CC6C0
.defineLabel ascii_HelloDMACopy_ROM_end, 0x7CC740
...
addiu sp, sp, -0x18
sw ra, 0x14 (sp)
sw a0, 0xA4 (sp) ; lvl cmd 0x11 safeguard
...
// Copies 0xA4 bytes from ROM addr 0x7CC6C0 to RAM addr 0x80370000
...
lw v0, 0xA4 (sp) ; lvl cmd 0x11 safeguard
lw ra, 0x14 (sp)
jr ra
addiu sp, sp, 0x18
.endarea
